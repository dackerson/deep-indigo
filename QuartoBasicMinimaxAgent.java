public class QuartoBasicMinimaxAgent extends QuartoAgent {

    //Example AI
    public QuartoBasicMinimaxAgent(GameClient gameClient, String stateFileName) {
    ...
    public static void main(String[] args) {
        ...
        QuartoBasicMinimaxAgent quartoAgent = new QuartoBasicMinimaxAgent(gameClient, stateFileName);
        quartoAgent.play();
